...
|---|---|---|
| **NILVER** | Predictiva (U1, batch) | ¿Cuál fue la temperatura mínima registrada por mes en Juliaca, y qué temperatura mínima se puede esperar el próximo mes según la tendencia histórica? |
...
| **NAYDER** | Predictiva (U1, batch) | ¿Cuál fue la precipitación acumulada por mes en Juliaca, y qué acumulado se puede esperar el próximo mes según la tendencia histórica? |
